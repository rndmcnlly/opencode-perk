...
> Status: primitives verified. This README briefs a future agent on what to build and, more importantly, why the shape matters. Read it before writing a line, then read [`RESEARCH.md`](./RESEARCH.md) for the verified *how* (primitives confirmed hands-on against opencode **1.15.12** on darwin). The README owns the *why*; RESEARCH owns the *verified how*.
